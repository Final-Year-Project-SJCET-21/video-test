...
const options =  {
    hosts: {
        domain: 'meet.fenstrok.com',

        muc: 'conference.'+subdomain+'meet.fenstrok.com', // FIXME: use XEP-0030
        focus: 'focus.meet.fenstrok.com',
    },
    serviceUrl: 'wss://meet.fenstrok.com/xmpp-websocket',
    ...
    externalConnectUrl: 'https://meet.fenstrok.com/http-pre-bind',
    analytics: {
    ...
    useTurnUdp: false,
    websocket: 'wss://meet.fenstrok.com/xmpp-websocket', // FIXME: use xep-0156 for that
    ...
    hiddenDomain: 'recorder.meet.fenstrok.com',
    dropbox: {
